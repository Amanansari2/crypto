...
class MaSettingSheet extends ConsumerStatefulWidget {
  const MaSettingSheet({super.key});

  @override
  ConsumerState<MaSettingSheet> createState() => _MaSettingSheetState();
}

class _MaSettingSheetState extends ConsumerState<MaSettingSheet> {
  bool initialized = false;

  int? openedColorPickerIndex;

  late List<MaSettingsModel> tempSettings;

  final List<TextEditingController> controllers = [];

  static const maColors = [
    Colors.yellow,
    Colors.indigo,
    Colors.blue,
    Colors.green,
  ...
  Widget build(BuildContext context) {
    ...
    final settings = ref.watch(maProvider);
              ...
              children: [
                Expanded(
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      ref.read(maProvider.notifier).reset();
                ...
                Expanded(
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      ref.read(maProvider.notifier).replaceAll(tempSettings);
