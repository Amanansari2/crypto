...
import '../../providers/chart_width_provider.dart';
...
import '../painters/shared_vertical_grid_painter.dart';



class ChartGestureLayer extends ConsumerStatefulWidget {

  final Widget child;
  final List<CandleModel> candles;


  const ChartGestureLayer({
    super.key,
    required this.child,
  ...
  @override
  ConsumerState<ChartGestureLayer> createState() => _ChartGestureLayerState();
}

class _ChartGestureLayerState extends ConsumerState<ChartGestureLayer> {
  double _startZoom = 1;
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        WidgetsBinding.instance.addPostFrameCallback((_) {
          ...
          final notifier =
          ref.read(viewportProvider.notifier);
          ...
          child: Stack(
            children: [
              ...
              Positioned.fill(
                child: IgnorePointer(
                  child: CustomPaint(
                    painter: SharedVerticalGridPainter(
                      context: context,
