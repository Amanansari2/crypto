                  ...
                  GridView(
                    ...
                    children: [
                      ...
                      StatCard(
                        ...
                        value: c.ath == null
                            ? '--'
                            : formatPrice(c.ath!, currencySymbol: curr),
                      ),
                      StatCard(
                        title: 'ATL',
                        value: c.atl == null
                            ? '--'
                            : formatPrice(c.atl!, currencySymbol: curr),
                      ),
                      StatCard(
                        title: 'High 24h',
                      ...
                      StatCard(
                        ...
                        value: c.low24h == null
                            ? '--'
                            : formatPrice(c.low24h!, currencySymbol: curr),
                      ),
                    ],
                  ),
                    ...
                    children: [
                      ...
                      if (pctFromAtl != null)
                        _MetaPill(
                          ...
                          color: isUp(pctFromAtl)
                              ? kGreenHex
                              : kRedHex, // green if above ATL
                        ),
                    ],
                  ),
